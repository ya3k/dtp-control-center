...
export default function SubscribeSection() {
  return (
    ...
    >
      <div className="flex h-full w-full flex-col justify-between gap-6 p-6 md:p-12">
        ...
        />
        <Button onClick={() => alert('Đăng ký thành công')} className="self-center bg-red-500 py-3 md:py-4 lg:py-6 px-6 md:px-8 lg:px-12 ">Đăng ký</Button>
      </div>
    </section>
  );
}
