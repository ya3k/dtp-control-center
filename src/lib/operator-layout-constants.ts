...
import { Banknote, Calendar, History, Home, MapPin, NotebookPen, Torus, Users, Wallet2 } from "lucide-react";
export const operatorItems: SidebarItem[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            { title: "FeedBack", url: "/operator/tours/feedback", icon: NotebookPen },
        ],
    },
    // {
    //     title: "Order",
